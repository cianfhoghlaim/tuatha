"""gael_formative_item_generate — Generate a Gaeilge formative item.

Backed by BAML `qpack_gaeilge.baml` `GenerateGaelFormativeItem`.

Gaeilge is taught in Irish — text_ga is canonical, text_en may be null
for native comprehension items.
"""
...
async def generate_gael_item(
    ...
    """Generate a single Gaeilge formative item for the given NCCA LO.

    `evidence` (`GaelEvidenceLink`-shaped: source_pdf, source_page,
