"""appm_formative_item_generate — Generate a formative APPM item."""
...
async def generate_appm_item(
    ...
    """`evidence` (`AppmEvidenceLink`-shaped: source_pdf, source_page,
    ...
    try:
        ...
        return {
            ...
            "hints": [{"en": h.text_en, "ga": h.text_ga} for h in item.hints],
