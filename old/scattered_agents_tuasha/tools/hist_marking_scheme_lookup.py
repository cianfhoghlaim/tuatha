"""hist_marking_scheme_lookup — Look up the NCCA History marking scheme."""
from __future__ import annotations

from typing import Any


async def lookup_hist_marking_scheme(lo_code: str) -> dict[str, Any]:
    try:
        import duckdb
