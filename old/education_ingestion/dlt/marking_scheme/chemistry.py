"""tuatha.dlt.marking_scheme.chemistry — the marking scheme DLT source for chemistry.
...
@dlt.resource(
    name=f"chemistry_marking_scheme",
    write_disposition="merge",
    primary_key=("ncca_code", "year", "level"),
)
def chemistry_marking_scheme_source() -> Iterator[dict[str, Any]]:
    """The canonical DLT source for chemistry marking_scheme."""
