"""tuatha.dlt.marking_scheme.geography — the marking scheme DLT source for geography.
...
@dlt.resource(
    name=f"geography_marking_scheme",
    write_disposition="merge",
    primary_key=("ncca_code", "year", "level"),
)
def geography_marking_scheme_source() -> Iterator[dict[str, Any]]:
    """The canonical DLT source for geography marking_scheme."""
