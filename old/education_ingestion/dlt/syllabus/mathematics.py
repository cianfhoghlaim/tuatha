"""tuatha.dlt.syllabus.mathematics — the syllabus DLT source for mathematics.
...
@dlt.resource(
    name=f"mathematics_syllabus",
    write_disposition="merge",
    primary_key=("ncca_code", "year", "level"),
)
def mathematics_syllabus_source() -> Iterator[dict[str, Any]]:
    """The canonical DLT source for mathematics syllabus."""
