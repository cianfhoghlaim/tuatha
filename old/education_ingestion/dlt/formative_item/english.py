"""tuatha.dlt.formative_item.english — the formative item DLT source for english.
...
@dlt.resource(
    name=f"english_formative_item",
    write_disposition="merge",
    primary_key=("ncca_code", "year", "level"),
)
def english_formative_item_source() -> Iterator[dict[str, Any]]:
    """The canonical DLT source for english formative_item."""
