...
async def app_main() -> None:
    ...
    # Per the 2026-08-27 change: xmen.scenes uses balanced (the
    # X-Men animation frames are similar density to Hades boons —
    # small character focus area + dense VFX + overlaid text).
    bias_by_source = {
        "hades.boons": "balanced",
        "comic.particles": "description_heavy",
        "gba.magic": "color_heavy",
        "xmen.scenes": "balanced",
    }
