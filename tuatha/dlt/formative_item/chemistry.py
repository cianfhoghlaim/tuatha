"""tuatha.dlt.formative_item.chemistry — the formative item DLT source for chemistry.
...
@dlt.resource(
    name=f"chemistry_formative_item",
    write_disposition="merge",
    primary_key=("ncca_code", "year", "level"),
)
def chemistry_formative_item_source() -> Iterator[dict[str, Any]]:
    """The canonical DLT source for chemistry formative_item."""
