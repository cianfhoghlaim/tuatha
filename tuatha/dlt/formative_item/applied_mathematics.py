"""tuatha.dlt.formative_item.applied_mathematics — the formative item DLT source for applied_mathematics.
...
@dlt.resource(
    name=f"applied_mathematics_formative_item",
    write_disposition="merge",
    primary_key=("ncca_code", "year", "level"),
)
def applied_mathematics_formative_item_source() -> Iterator[dict[str, Any]]:
    """The canonical DLT source for applied_mathematics formative_item."""
