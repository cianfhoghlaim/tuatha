"""tuatha.dlt.formative_item.irish — thin re-export of the per_subject template.
...
irish_formative_item_source = partial(ncca_formative_item_source, subject="irish")
