"""tuatha.dlt.response_score.history — the response score DLT source for history.
...
@dlt.resource(
    name=f"history_response_score",
    write_disposition="merge",
    primary_key=("ncca_code", "year", "level"),
)
def history_response_score_source() -> Iterator[dict[str, Any]]:
    """The canonical DLT source for history response_score."""
