"""tuatha.dlt.response_score.irish — thin re-export of the per_subject template.
...
irish_response_score_source = partial(ncca_response_score_source, subject="irish")
