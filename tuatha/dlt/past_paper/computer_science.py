"""tuatha.dlt.past_paper.computer_science — the past paper DLT source for computer_science.
...
@dlt.resource(
    name=f"computer_science_past_paper",
    write_disposition="merge",
    primary_key=("ncca_code", "year", "level"),
)
def computer_science_past_paper_source() -> Iterator[dict[str, Any]]:
    """The canonical DLT source for computer_science past_paper."""
