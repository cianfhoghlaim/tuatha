"""tuatha.dlt.past_paper.mathematics — the past paper DLT source for mathematics.
...
@dlt.resource(
    name=f"mathematics_past_paper",
    write_disposition="merge",
    primary_key=("ncca_code", "year", "level"),
)
def mathematics_past_paper_source() -> Iterator[dict[str, Any]]:
    """The canonical DLT source for mathematics past_paper."""
