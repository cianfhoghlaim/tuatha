"""tuatha.dlt.marking_scheme.irish — thin re-export of the per_subject template.
...
irish_marking_scheme_source = partial(ncca_marking_scheme_source, subject="irish")
