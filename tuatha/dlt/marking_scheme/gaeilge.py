"""tuatha.dlt.marking_scheme.gaeilge — the marking scheme DLT source for gaeilge.
...
@dlt.resource(
    name=f"gaeilge_marking_scheme",
    write_disposition="merge",
    primary_key=("ncca_code", "year", "level"),
)
def gaeilge_marking_scheme_source() -> Iterator[dict[str, Any]]:
    """The canonical DLT source for gaeilge marking_scheme."""
