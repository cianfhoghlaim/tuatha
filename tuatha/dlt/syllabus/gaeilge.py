"""tuatha.dlt.syllabus.gaeilge — the syllabus DLT source for gaeilge.
...
@dlt.resource(
    name=f"gaeilge_syllabus",
    write_disposition="merge",
    primary_key=("ncca_code", "year", "level"),
)
def gaeilge_syllabus_source() -> Iterator[dict[str, Any]]:
    """The canonical DLT source for gaeilge syllabus."""
