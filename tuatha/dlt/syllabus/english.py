"""tuatha.dlt.syllabus.english — the syllabus DLT source for english.
...
@dlt.resource(
    name=f"english_syllabus",
    write_disposition="merge",
    primary_key=("ncca_code", "year", "level"),
)
def english_syllabus_source() -> Iterator[dict[str, Any]]:
    """The canonical DLT source for english syllabus."""
